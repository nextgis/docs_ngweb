...
действие над слоем - "Таблица объектов". В результате чего формируется таблица 
атрибутов объектов, имеющая следующий вид :numref:`admin_table_objects_upload`.
...
В результате чего формируется таблица атрибутов объектов. Сформированная таблица 
атрибутов объектов позволят выполнить следующие операции над выделенной записью :numref:`admin_table_objects2_upload`:
