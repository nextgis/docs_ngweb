...
вместо имени поля в окне идентификации. В столбцe :guilabel:`Ключ` можно поменять название атрибута.
...
Файлы сохраняются в той системе координат, что хранятся внутри NextGIS Web - EPSG:3857.
