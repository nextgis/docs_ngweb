...
Блок операций (см. :numref:`ngweb_main_page_administrative_interface_pic`, п.7, 8) позволяет как создать новые типы ресурсов в NextGIS Web, так и изменить/удалить текущую (здесь - основную).
...
Подробнее эти настройки рассмотрены в разделе административых задач :ref:`ngw_admin_tasks`.
