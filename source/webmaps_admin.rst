...
При добавлении слоя задаётся его стиль. В окне свойств поля можно выбрать Стиль MapServer 
или Стиль QGIS. При этом откроется окно, в котором можно импортировать стиль из QGIS 
в формате QML или ввести его вручную. Настройки слоев на веб-карте представлены 
