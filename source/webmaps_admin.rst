...
Переход к изменению настроек веб-карты
--------------------------------------

Вы можете нажать "Изменить ресурс" на странице ресурса веб-карты, в дереве слоёв или в окне просмотра веб-карты.
...
Если вы переходите к настройкам из режима просмотра веб-карты, они откроются в новой вкладке.
