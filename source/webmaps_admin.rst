...
Поле "Непрозрачность" обозначает степень просвечивания слоя на карте. 
Прозрачность каждого слоя может быть настроена от 0 (полностью прозрачный) до 100 % (непрозрачный).
...
На  вкладке "Подложки" можно добавлять подложки и удалять их, для чего предусмотрены соответствующие кнопки "Добавить" и "Удалить" или выбрать вариант `без подложки <https://docs.nextgis.ru/docs_ngweb/source/webmaps_admin.html#ngw-map-no-base>`_. 
...
По умолчанию веб-карта создаётся с подложкой OpenStreetMap. Если нужно получить карту без подложки, на вкладке "Подложки" нажмите **Дополнительные настройки**.
...
Поставьте галочку **Отключить подложки**.
...
Также здесь можно указать цвет фона. По умолчанию фон белый. Если вы делаете карту без подложки или с подложкой с прозрачными областями, этот цвет будет виден.
...
Редактирование настроек веб-карты
--------------------------------------

Вы можете нажать |button_edit| "Изменить ресурс" на странице ресурса веб-карты, в дереве слоёв или в окне просмотра веб-карты.

.. |button_edit| image:: _static/button_edit.png
   :width: 6mm


.. figure:: _static/webmap_open_settings_ru.png
   :name: webmap_open_settings_pic
   :align: center
   :width: 20cm

   Переход к настройкам веб-карты из режима просмотра

Если вы переходите к настройкам из режима просмотра веб-карты, они откроются во всплывающем окне.

.. figure:: _static/webmap_settings_on_map_ru.png
   :name: webmap_settings_on_map_pic
   :align: center
   :width: 20cm
