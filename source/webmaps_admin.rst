...
Карта с белой подложкой
~~~~~~~~~~~~~~~~~~~~~~~~~

По умолчанию веб-карта создаётся с подложкой OSM. Если вы хотите получить карту на белой подложке, то создайте в корневой группе ресурсов новую подложку, задайте ей URL "blank", и добавьте её к веб-карте. Если к веб-карте добавлены подложки, то подложки OSM не будет.
