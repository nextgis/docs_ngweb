...
Для создании группы ресурсов необходимо перейти в ту группу (корневая или др.) и в панели операций выбрать Создать ресурс → Группа ресурсов. При этом откроется окно, представленное на рис. 4.14.
