...
В Веб ГИС можно подключить мониторинг движущихся объектов (трекинг).
...
Операции, доступные по клику на три точки в правой части строчки трек:
...
.. admonition:: Научим ваших сотрудников работать в нашем ПО
