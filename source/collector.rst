...
В настоящем разделе описываются принципы организации сбора пространственных данных при помощи приложения NextGIS Collector и даётся краткая инструкция для организатора, в том числе добавление участников, создание проекта сбора данных, и для участников.
