...
Также можно добавить к слою форму через веб-интерфейс. Зайдите в ресурс слоя, для которого хотите создать форму сбора данных.
...
Через веб-интерфейс можно **заменить** форму сбора данных, подключаемую к слою. Создайте внутри слоя новый ресурс формы. Затем удалите старую форму. Форму, созданную через конструктор в веб-интерфейсе, можно впоследствии редактировать на той же вкладке.

После замены или изменения формы в приложении Collector запустите синхронизацию. Подгрузится новая форма, через которую можно будет продолжать собирать данные в тот же слой.
