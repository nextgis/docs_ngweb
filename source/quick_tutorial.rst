...
* Геоданные для карт могут добавляться из :term:`PostGIS`, либо загружаются из 
  файловых :abbr:`ГИС (геоинформационная система)` форматов :term:`ESRI Shapefile`, :term:`GeoJSON`, :term:`KML`, :term:`GeoPackage`, :term:`GeoTIFF` и многих других форматов.
* Векторные данные можно скачивать в виде файлов в форматах :term:`GeoJSON`, :term:`CSV`, :term:`ESRI Shapefile`, MapInfo TAB, AutoCAD DXF в необходимой системе координат.
...
Создание векторного слоя из :term:`ESRI Shapefile` включает в себя ряд этапов:
