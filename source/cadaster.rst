...
.. note:: Если у вас NextGIS Web на своём сервере, то для отображения кадастровых данных в виде подложек нужно зайти на https://geoservices.nextgis.com/settings/profile и добавить новый Origin: домен вашей Веб ГИС.
