...
2. Кликните по узлу и перетащите его в нужное место, зажимая левую кнопку мыши. При перемещении узлов будет работать прилипание. Чтобы отключить прилипание, нажмите |button_maptool_snap| и снемите все галочки.
