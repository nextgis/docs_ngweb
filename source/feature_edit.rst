...
* |button_maptool_snap| прилипание (синяя = включено, белая = выключено), по нажатию на неё открывается меню, где можно включить прилипание к ребрам, вершинам и/или пересечениям. Если снять все галочки, прилипание будет выключено;
...
При создании узлов будет работать прилипание. Чтобы отключить его, нажмите |button_maptool_snap| и снимите все галочки.
...
2. Кликните по узлу и перетащите его в нужное место, зажимая левую кнопку мыши. При перемещении узлов будет работать прилипание. Чтобы отключить прилипание, нажмите |button_maptool_snap| и снимите все галочки.
...
.. figure:: _static/webmap_identification_photo_lightbox_rus_4.png
...
При просмотре можно приблизить/отдалить изображение и повернуть его. Также из окна просмотра можно скачать фотографию на устройство.

Навигация по панорамам осуществляется мышью. Зажимайте левую кнопку мыши и вращайте камеру. Колёсиком приближайте и отдаляйте обзор. Режим панорамы у снимка можно отключать кнопкой |button_panorama_toggle|.

.. figure:: _static/panorama_opened_ru_2.png
...
Также поддерживается переход между связаными панорамами. Если у вас есть тур в формате Garden Gnome Package (.ggpkg), экспортированный из Pano2VR, вы можете `конвертировать его в набор панорам с точками навигации <https://toolbox.nextgis.com/t/pano2vr>`_. Переход к соседним панорамам обозначен красными точками.

.. figure:: _static/panorama_connected_ru.png
   :name: panorama_connected_pic
   :align: center
   :width: 20cm

   Навигация между связанными панорамами
...
Доступно две вкладки - экспорт и импорт. Экспорт позволяет сохранить описания в виде ZIP-архива. 
...
Отключение редактирования на веб-карте
--------------------------------------
