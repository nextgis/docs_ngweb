...
.. warning:: 
   ...
   Установка NextGIS WEB на CentOS возможна, но данная документация может отставать от актуальной.
...
Создаем базу, в которую будет развернута NextGIS WEB, имя базы должно быть таким
