...
**Фильтр** позволяет отображать на карте только те объекты слоя, которые отвечают заданным условиям.
...
Флажок **Идентифицируемый** означает, что при клике на объекты слоя информация о них отображается в панели идентификации. Если его отключить, то объекты этого слоя будут игнорироваться инструментом идентификаци.
