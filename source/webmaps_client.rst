...
В строке поиска (см. :numref:`ngweb_webmap_client`, п.5) по мере ввода будет производиться поиск по двум источникам:
...
С помощью функции "Поделиться" (см. :numref:`ngweb_webmap_client`, п.6) формируется ссылку на карту, а с помощью функции "Распечатать карту" (см. :numref:`ngweb_webmap_client`, п.7) открывается окно подготовки к печати. 
