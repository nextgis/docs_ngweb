...
Для работы с картой предусмотрены инструменты (5), которые перечислены слева направо:
...
Строка статуса (7) отображает координаты клика и текущий масштаб.i
...
надо слева сверху нажать кнопку "Просмотреть". В окне просмотра 
