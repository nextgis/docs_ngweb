...
.. note::
   Для того, чтобы найти точку по координатам, в строку поиска следует ввести значения долготы и широты в градусах, минутах и секундах или в десятичном формате, например: 37°27'E, 55°8'N или 37 55; 37,5 55,1; 37.457723 55.145696.
