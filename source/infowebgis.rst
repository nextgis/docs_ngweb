...
На этой странице можно посмотреть текущий `план подписки <https://nextgis.ru/pricing-base/>`_ владельца Веб ГИС и перейти `в личный кабинет <https://docs.nextgis.ru/docs_ngcom/source/subscription.html>`_ для его изменения.

Также отображается доступные `на текущем плане <https://nextgis.ru/pricing-base/>`_ функции и квоты:

* Количество слоёв, которые можно создать (на Free - до 15, для плана Premium - не ограничено);
