...
На странице "Информация о системе" NextGIS Web, развёрнутой на своём сервере,  можно проверить не только данные установленных пакетов, но и наличие обновлений. Если обновление доступно, сообщение об этом будет отображаться в верхней части страницы.
