...
.. note:: NextGIS team can perform the upgrade remotely, if you provide remote access that fits the `requirements <https://docs.nextgis.com/docs_onpremise/source/remote.html>`_.
