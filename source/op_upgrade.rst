...
В случае отсутствия доступа к Интернету, сгенерируйте архивов с образами при помощи инструмента  `Выгрузка из реестра контейнеров NextGIS <https://toolbox.nextgis.com/t/ngcr_export>`_, загрузите их на сервер и выполните команду загрузки образов из архива:
