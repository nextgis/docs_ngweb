...
* Редактирование атрибутов из административного интерфейса: 
  ...
  - Нажать на кнопку "Редактировать" над таблицей :numref:`ngweb_editing_attributes2.7`.
...
3. В окне редактирования открыть вкладку "Вложения" 
   (см. :numref:`ngweb_tab_attachment`).
