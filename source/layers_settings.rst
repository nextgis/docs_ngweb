...
Далее перейдите в редактирование векторного слоя, во вкладке Атрибуты выберите нужную строку и нажмите на стрелку вниз в колонке Справочник.
...
Чтобы тот же список значений был доступен при сборе данных в поле, экспортируйте справочник в формате CSV и добавьте его к полю `формы сбора данных <https://docs.nextgis.ru/docs_formbuilder/source/controls.html#fb-edit-combobox-pic>`_. 
