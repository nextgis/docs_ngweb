...
Для того, чтобы удалить лишний узел, в режиме редактирования объекта нужно зажать клавишу **Shift** и кликнуть по этому узлу. Также вы можете перетянуть узел к соседнему, и они сольются в один.
