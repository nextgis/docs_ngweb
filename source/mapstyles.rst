...
.. warning::   
   For the tile cache to work, the **Image** adapter must be enabled in the web map `settings https://docs.nextgis.com/docs_ngweb/source/webmaps_admin.html#admin-webmap-create-layers>`_.
