...
Стили служат для описания способов отрисовки геоданных и являются одним из ресурсов NGW. 


Создания стиля
----------------------------------

Стиль привязан к соответствующему слою и поэтому вы не найдете пункта "Стиль" в основном списке ресурсов. 
