...
Если вы хотите настроить создаваемый стиль, то нужно в блоке операций на правой боковой панели в разделе "Создать ресурс" выбрать "Векторный стиль QGIS" (см. :numref:`select_qgis_style`).
...
Для того, чтобы загрузить готовыйстиль, на вкладке **Стиль QGIS** необходимо выбрать qml-файл стиля на устройстве или перетащить его в эту область (см. :numref:`upload_svg_qgis_style`).
...
Далее на вкладке «Ресурс» необходимо ввести наименование в соответствующее поле.
