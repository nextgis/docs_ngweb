...
If you use a different Linux installation package, make sure that the Linux kernel version on the server is 5.10 or above, which corresponds to the current LTS version.
