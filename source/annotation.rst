...
и отображать поверх любой `веб-карты <https://docs.nextgis.ru/docs_ngweb/source/webmaps_admin.html>`. Для каждой веб-карты вы можете создавать свой собственный набор аннотаций.
