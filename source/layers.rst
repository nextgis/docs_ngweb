...
.. note:: 
   Если вы подготавливаете данные для загрузки c помощью QGIS или GDAL, то не следует использовать EPSG:3857. GDAL при сохранении и спользует неверное описание проекции, в результате чего данные при загрузке будут иметь смещение. Используйте EPSG:4326 или другие СК.
...
#. Поля :guilabel:`Тип геометрии`, :guilabel:`Система координат` и :guilabel:`Описание атрибутов` не являются обязательными и могут быть оставлены по-умолчанию.
