...
В блоке с перечнем ресурсов в основной группе в том числе имеется инструмент для добавления 
данных и выполнения операций под названием "Справочник". Для создания необходимого 
нового ресурса выбираем из перечня ресурсов тип Справочник. Откроется окно Создать 
ресурс, где следует выбрать вкладку Справочник. Откроется окно в виде таблицы с 
кнопками Добавить и Удалить. При нажатии на кнопку Добавить выпадает вкладка Text, 
которая предоставляет возможность ввести имеющиеся данные. После ввода необходимых 
данных, следует нажать на кнопку Сохранить:
...
.. figure:: _static/ngweb_creating_a_new_directory.png
   ...
   Создание нового ресурса типа "Справочник", ввод данных.
 
Создастся новый ресурс типа Справочник:
...
Для внесения необходимых изменений в созданный ранее ресурс в блоке с перечнем ресурсов 
следует выбрать вкладку Действие, далее вкладку Изменить, после нажатия на которую 
откроется окно для редактирования данных ресурса, куда возможно внести необходимые 
изменения и нажать на кнопку Сохранить.
Для удаления ранее созданного ресурса в блоке с перечнем ресурсов следует выбрать 
вкладку Действие, далее вкладку Удалить, после нажатия на которую откроется окно, 
где следует подтвердить удаление ресурса проставлением галочки в соответствующем окошке 
и нажать на кнопку Удалить:

.. figure:: _static/ngweb_deleting_a_resource.png
   :name: ngweb_deleting_a_resource_group
   :align: center
   :width: 16cm
