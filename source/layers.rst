...
Если во входном файле есть поля с названиями: id (ID), geom (GEOM), то при загрузке они будут переименованы или превращены во внутренние идентификаторы (поле id).
