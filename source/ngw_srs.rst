...
.. hint:: Хотите научиться работать с системами координат?
   ...
   Курс `Фундаментальный QGIS <https://nextgis.skillspace.ru/l/qgis?from-docs>`_ подробно рассказывает о системах координат и проекциях. Вы научитесь переводить данные из одной СК в другую, добавлять местные СК и проводить измерения на эллипсоиде и плоскости.
