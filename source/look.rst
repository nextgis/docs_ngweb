...
По умолчанию выделенный объект подсвечивается жёлтым.
...
Отображение возможности экспорта ресурсов
------------------------------------------

Настройка "Экспорт ресурсов" показывает в интерфейсе Веб ГИС возможность экспорта (сохранения) данных только для тех категорий пользователей, которые выбраны из соответствующего списка. 
...
* Перейдите в Панель управления -> Настройки -> Экспорт Ресурсов см. :numref:`admin_system_res_export`
