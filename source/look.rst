...
.. note:: 
	Эти настройки может изменять только пользователь с правами администратора. Кроме смены названия и управления шрифтами, другие настройки внешнего вида доступны только для плана `Premium <http://nextgis.ru/nextgis-com/plans>`_ .
