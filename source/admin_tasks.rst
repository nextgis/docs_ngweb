...
Кроме стандартных пользователей есть заранее созданные специальные системные пользователи:
...
Также по умолчанию в Веб ГИС созданы две неудаляемые системные группы пользователей:

* Администраторы - группа, пользователи которой обладают административными правами
* Editors - группа, пользователи которой не имеют доступа в панель управления, но обладают остальным функционалом системы
