...
6. В веб-гис nextgis.com создать аккаунт с зарезанными правами, от имени которого будут добавляться записи в веб-гис.
   Полное имя - Collector. Логин - Collector. Пароль - сгенерировать и вставить openssl rand -base64 14
 , вручную его вводить не понадобится. Описание - Аккаунт для работы NextGIS Collector. Член Групп - только Editors
6. Заставить главного человека по работе в поле зарегистрироваться на nextgis.com. Получить его e-mail.

#. Переключить интерфейс веб-гис на нужный язык
