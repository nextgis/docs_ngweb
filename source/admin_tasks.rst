...
Адресный поиск в NextGIS Web осуществляется по двум базам адресов:
...
* "Ограничить странами" - работает для поиска OSM. Формат - ru, de.
* "Ключ геокодера API Яндекс.Карт" - получение силами пользователя - https://developer.tech.yandex.ru/
