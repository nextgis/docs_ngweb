...
7. В веб-гис nextgis.com создать подложку, использовать запрос OpenStreetMap Standart. Назвать её OpenStreetMap Carto.
8. В веб-гис nextgis.com создать проект сбора.
