...
Для пользователей и групп пользователей можно `настроить права доступа <https://docs.nextgis.ru/docs_ngcom/source/permissions.html>`_ к Веб ГИС в целом и отдельным ресурсам.
