...
Для открытия этого окна необходимо в основном меню (см. :numref:`ngweb_main_page_administrative_interface_pic`, п.1) выбрать пункт "Панель управления" (см. :numref:`ngweb_main_page_main_menu_pic`). На Панели управления (см. :numref:`ngweb_admin_control_panel`) следует выбрать команду "Создать" в подпункте "Группы пользователей".
...
* Пароль для входа
* Группа(-ы), к которым относится пользователь (в списке будут отображены 
...
Закрыть в открытом инстансе nextgis.com группу для гостей, открыть для специального пользователя
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

Задать в свойствах группы ресурсов: 

* Запретить-гостю-всё-всё-распространить
* Разрешить-юзеру-всё-всё-распространить


Задать в свойствах корневой группы ресурсов: 

* Разрешить-юзеру-ресурс:чтение-всё-распространить

Альтернативно - разрешить этому юзеру чтение на все вышестоящие группы ресурсов. 
...
Можно изменять внешний вид NextGIS Web. Внешний вид включает: логотипы, цвета шапки, фона, кнопок и других элементов.

#. Для этого необходимо войти в NextGIS Web с правами администратора, открыть раздел "Панель управления" и выбрать пункт "Пользовательские стили CSS". 
