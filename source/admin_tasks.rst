...
Список избранных ресурсов можно изменять: удалять из него ресурсы и редактировать название добавленных фрагментов карты (`подробнее о работе с избранным <https://docs.nextgis.ru/docs_ngcom/source/favorites.html>`_).
...
* Права - `глобальные права пользователя <https://docs.nextgis.ru/docs_ngweb/source/admin_tasks.html#ngw-group-rights>`_
