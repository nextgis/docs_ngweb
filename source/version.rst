...
Во всплывающем окне выберите группу ресурсов, в которой будет сохранена копия слоя. По умолчанию выбрана группа, в которой расположен исходный слой. Нажмите :button:, чтобы выбрать другую папку.
