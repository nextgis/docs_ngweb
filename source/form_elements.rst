...
* `Пробел <https://docs.nextgis.ru/docs_ngweb/source/form_elements.html#form-spacer>`_ - пустое место, отделяющее один раздел формы от другого;
...
.. todo:: _static/form_with_spacers_ru.png
...
Опции вводятся в виде таблицы. Их можно ввести вручную или `импортировать из CSV <https://docs.nextgis.ru/docs_ngweb/source/form_elements.html#import-csv>`_.
...
.. figure:: _static/options_edit_open_ru.png
   :name: options_edit_open_pic
   :align: center
   :width: 20cm

   Переход к редактированию опций выпадающего списка
...
.. figure:: _static/options_csv_preview_ru.png
   ...
   Настройки импорта из CSV

Выберите колонки, которые будут использоваться в этом элементе как:
...
Если получающая таблица вас устраивает, нажмите **Импортировать**.

.. figure:: _static/options_imported_ru.png
